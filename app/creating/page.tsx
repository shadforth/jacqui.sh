...
const pixelArt = [
  ...
  { src: '/media/pixel-art/red-house_640.png', alt: 'A house' },
  ...
  { src: '/media/pixel-art/pigeon_768.gif', alt: 'Pidgey' },
]
...
const baking = [
  ...
  { src: '/media/baking/sourdough.jpeg', alt: 'Sourdough loaf' },
  { src: '/media/baking/soux.jpeg', alt: 'Choux pastry' },
]
