...
export const metadata = {
  title: 'Building',
  description: 'Projects and products built by Jacqui Shadforth.',
}
...
const projects = [
  {
    ...
    logo: '/media/building/logos/bulka.jpg',
    logoBg: undefined,
    logoPadding: false,
    live: true,
  },
  {
    ...
    logo: '/media/building/logos/ddd.png',
    logoBg: '#020617',
    logoPadding: true,
    live: true,
  },
  {
    ...
    logo: '/media/building/logos/cloud.png',
    logoBg: '#3B6594',
    logoPadding: true,
    live: true,
  },
  {
    ...
    logo: '/media/building/logos/polish.png',
    logoBg: '#F4BD42',
    logoPadding: true,
    wip: true,
  },
      ...
      <ul className="building-projects-list">
        {projects.map((p) => (
          <li key={p.name} className="building-project-item">
            <div
              className="building-logo-container"
              style={{ background: p.logoBg ?? 'hsl(var(--muted))' }}
            >
              <TrackedLink
                href={p.url}
            ...
            <div className="building-project-content">
              <div className="building-project-header">
                <span className="building-project-title">
                  ...
                  {p.live && <span className="building-badge building-badge-active">active</span>}
                  {p.wip && <span className="building-badge building-badge-wip">shelved</span>}
                </span>
              ...
              <p className="building-description">{p.description}</p>
            </div>
          </li>
        ))}
      </ul>
