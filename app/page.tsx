      ...
      <section className="hero-section mb-6">
        <div>
          <h1 className="heading-markazi">
            Hi! I&rsquo;m Jacqui.<NamePronunciation />
          </h1>
      ...
      <section className="mb-14">
        ...
        <ul className="quick-links-list">
          <li>
            ...
            <span className="text-muted"> occasionally about software, systems, and other detours</span>
          </li>
          <li>
          ...
          <li>
            <Link href="/creating" className={quickLinkClassName}>Creating</Link>
