...
export const IpodCard = ({ track: musicTrack }: { track: MusicTrack }) => {
  ...
  const { toggleVideo, skipVideoForward, skipVideoBackward, toggleMute, isVideoMuted } =
    useIpodVideo(view)
  ...
  return (
    <div className="media-card">
      <div
        className={`media-screen-base ipod-screen ${view === 'photos' ? 'ipod-screen-photos' : ''}`}
        style={{ padding: view === 'videos' ? '0' : undefined }}
      >
        {view === 'nowPlaying' && (
          <IpodNowPlaying
